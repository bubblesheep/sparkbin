...
print("After autobinning using sparkbin package, the input variables are binned into: ")
print(binobjs)

# Transformation and modeling--------------------------------------------------
train_transformed <- bin_transform_batch(train, binobjs)
formula <- paste0("target~", paste0("ft_", names(binobjs), collapse = "+"))
print(paste("The model formula is:", formula))
...
print(paste("Final model AUC:", auc))
